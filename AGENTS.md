...
- You MUST maintain the changelog: always add a concise summary for non-technical audiences of user-facing changes to both `CHANGELOG.md` and `assets/changelog.json` whenever you modify behavior or appearance that should surface in the in-app update notes.
