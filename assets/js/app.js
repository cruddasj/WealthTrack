...
function handleFormSubmit(e) {
  ...
  switch (form.id) {
    ...
    case "takeHomePayForm": {
      ...
      const fmtRow = (label, annual, bonusValue = null) => {
      ...
      const monthlyThresholds = {
        ...
        higherLimit: (taxYearCfg?.higherLimit ?? 125140) / 12,
        primaryNiThreshold: (taxYearCfg?.primaryNiThreshold ?? 12570) / 12,
      ...
      rows.push(
        ...
        fmtRow(
          "Income tax",
          incomeTax,
          bonus > 0 ? incomeTax / 12 + bonusTaxDelta : null,
        ),
        fmtRow(
          "National Insurance",
          nationalInsurance,
...
if (typeof module !== 'undefined') {
  module.exports = {
    ...
    migrateStorageKeys,
    getStoredFirstTimeHidden,
    setStoredFirstTimeHidden,
    isFirstTimeContentHidden,
    applyFirstTimeContentHidden,
    normalizeCardHeadings,
    setImportProfileHint,
    closeProfilePicker,
    closeAllProfilePickers,
    updateProfilePickerSummary,
    populateProfilePickerOptions,
    resetProfilePicker,
    getProfilePickerSelection,
    getPassiveEligibleAssets,
    sanitizeThemeChoice,
    sanitizeMobileNavSticky,
    readStoredMobileNavSticky,
    applyMobileNavSticky,
    applyThemeChoice,
    applyDarkMode,
    applyProfilePreferences,
    ensureArray,
    sanitizePassiveSelection,
    loadPassiveAssetSelection,
    ...
    buildDepositDate,
    addMonthsForDeposit,
    firstDepositOnOrAfter,
    createDepositIterator,
    startOfToday,
    toTimestamp,
    parseDateInput,
    toDateInputValue,
